...
package hu.joszolgalat.android.app.database;
...
public interface IMapSchema {
	...
	public static final String DEMO_DESC = "joszolgalat.hu dev-BETA";

	public static final String DEMO_NAME = "joszolgalat.hu";

	public static final String DEMO_DATE = (new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss")).format(new Date());

	public static final String DEMO_URL = "http://joszolgalat.hu";

	public static final String DEMO_LATITUDE = "47.2";

	public static final String DEMO_LONGITUDE = "19.1";
	// Deployments
