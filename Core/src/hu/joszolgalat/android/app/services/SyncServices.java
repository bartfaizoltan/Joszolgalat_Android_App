...
package hu.joszolgalat.android.app.services;
...
public abstract class SyncServices extends IntentService {
	...
	public static String SYNC_SERVICES_ACTION = "hu.joszolgalat.android.app.services.sync";
//	public static String SYNC_SERVICES_ACTION = "com.ushahidi.android.app.services.sync";
	
	public static String UPLOAD_CHECKIN_SERVICES_ACTION = "hu.joszolgalat.android.app.services.uploadcheckin";
//	public static String UPLOAD_CHECKIN_SERVICES_ACTION = "com.ushahidi.android.app.services.uploadcheckin";
	
	public static String FETCH_CHECKIN_SERVICES_ACTION = "hu.joszolgalat.android.app.services.fetchcheckin";
//	public static String FETCH_CHECKIN_SERVICES_ACTION = "com.ushahidi.android.app.services.fetchcheckin";
	
	public static String FETCH_CHECKIN_COMMENTS_SERVICES_ACTION = "hu.joszolgalat.android.app.services.fetchcheckincomments";
//	public static String FETCH_CHECKIN_COMMENTS_SERVICES_ACTION = "com.ushahidi.android.app.services.fetchcheckincomments";
	
	public static String FETCH_REPORT_COMMENTS_SERVICES_ACTION = "hu.joszolgalat.android.app.services.fetchreportcomments";
//	public static String FETCH_REPORT_COMMENTS_SERVICES_ACTION = "com.ushahidi.android.app.services.fetchreportcomments";
	
	public static String UPLOAD_COMMENT_SERVICES_ACTION = "hu.joszolgalat.android.app.services.uploadcomment";
